...
Après avoir configuré tous les équipements (Mise en place d'antennes WiFi sur les PC portables, activation du DHCP sur les PC fixes, mise en place d'un module IP VoIP adapter sur le PC fixe), nous pouvons procéder au câblage final et à la vérification de la connectivité.
