...
Les switchs ont reçu 8 modules PT-SWITCH-NM1CGE pour normaliser les ports. Nous n'avons pas pu mettre de ports fibres sur les switchs pour les reconnecter au routeur car le routeur n'est pas compatible avec 4 ports fibre; il n'a que des modules RJ45.
